...
public class SnapshotDeletionPolicyTests extends ElasticsearchTestCase {
    ...
    public void setUp() throws Exception {
        ...
        indexWriter = new IndexWriter(dir, new IndexWriterConfig(TEST_VERSION_CURRENT, Lucene.STANDARD_ANALYZER).setIndexDeletionPolicy(deletionPolicy).setOpenMode(IndexWriterConfig.OpenMode.CREATE));
    }
