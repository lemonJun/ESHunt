...
public class TransportIndexFailuresTest extends ElasticsearchIntegrationTest {
    ...
    private static final Settings nodeSettings = ImmutableSettings.settingsBuilder().put("discovery.type", "zen") // <-- To override the local setting if set externally
                    ...
                    .put("discovery.zen.minimum_master_nodes", 1).put(TransportModule.TRANSPORT_SERVICE_TYPE_KEY, MockTransportService.class.getName()).build();
