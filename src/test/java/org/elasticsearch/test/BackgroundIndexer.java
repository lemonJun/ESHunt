...
public class BackgroundIndexer implements AutoCloseable {
     ...
     */
    public BackgroundIndexer(final String index, final String type, final Client client, final int numOfDocs, final int writerCount, boolean autoStart, Random random) {
    ...
    private XContentBuilder generateSource(long id, Random random) throws IOException {
        ...
        builder.startObject().field("test", "value" + id).field("text", text.toString()).endObject();
        return builder;
