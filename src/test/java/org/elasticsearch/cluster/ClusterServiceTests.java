...
public class ClusterServiceTests extends ElasticsearchIntegrationTest {
    ...
    public void testClusterStateUpdateLogging() throws Exception {
        ...
        mockAppender.addExpectation(new MockLogAppender.SeenEventExpectation("test3", "cluster.service", Level.DEBUG, "*processing [test3]: took * done applying updated cluster_state (version: *)"));
        ...
        try {
            ...
            clusterService1.submitStateUpdateTask("test3", new ProcessedClusterStateUpdateTask() {
                @Override
                public ClusterState execute(ClusterState currentState) {
                    return ClusterState.builder(currentState).version(currentState.version() + 1).build();
                }
