...
public class DisableAllocationTests extends ElasticsearchAllocationTestCase {
    ...
    public void testClusterDisableAllocation() {
        AllocationService strategy = createAllocationService(settingsBuilder().put(DisableAllocationDecider.CLUSTER_ROUTING_ALLOCATION_DISABLE_NEW_ALLOCATION, true).put(DisableAllocationDecider.CLUSTER_ROUTING_ALLOCATION_DISABLE_ALLOCATION, true).build());
    ...
    public void testClusterDisableReplicaAllocation() {
        AllocationService strategy = createAllocationService(settingsBuilder().put("cluster.routing.allocation.disable_replica_allocation", true).build());
