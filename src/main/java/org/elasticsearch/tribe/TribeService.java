...
public class TribeService extends AbstractLifecycleComponent<TribeService> {
    ...
    private static final String ON_CONFLICT_ANY = "any",
                    ON_CONFLICT_DROP = "drop", ON_CONFLICT_PREFER = "prefer_";
        ...
        public void clusterChanged(final ClusterChangedEvent event) {
            ...
            clusterService.submitStateUpdateTask("cluster event from " + tribeName + ", " + event.source(), new ClusterStateNonMasterUpdateTask() {
                ...
                public ClusterState execute(ClusterState currentState) throws Exception {
                    ...
                    return ClusterState.builder(currentState).version(currentState.version() + 1).blocks(blocks).nodes(nodes).metaData(metaData).routingTable(routingTable).build();
                }
