...
public final class Preconditions {
    ...
    public static void checkArgument(boolean expression, String errorMessageTemplate, Object... errorMessageArgs) {
        if (!expression) {
            throw new ElasticsearchIllegalArgumentException(format(errorMessageTemplate, errorMessageArgs));
        }
    }
    ...
    public static void checkState(boolean expression, String errorMessageTemplate, Object... errorMessageArgs) {
        if (!expression) {
            throw new ElasticsearchIllegalStateException(format(errorMessageTemplate, errorMessageArgs));
        }
    }
    ...
    public static <T> T checkNotNull(T reference, String errorMessageTemplate, Object... errorMessageArgs) {
        if (reference == null) {
            ...
            throw new ElasticsearchNullPointerException(format(errorMessageTemplate, errorMessageArgs));
        }
        return reference;
    }
