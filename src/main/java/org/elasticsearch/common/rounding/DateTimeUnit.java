...
public enum DateTimeUnit {
    ...
    WEEK_OF_WEEKYEAR((byte) 1, ISOChronology.getInstanceUTC().weekOfWeekyear()), YEAR_OF_CENTURY((byte) 2, ISOChronology.getInstanceUTC().yearOfCentury()), QUARTER((byte) 3, Joda.QuarterOfYear.getField(ISOChronology.getInstanceUTC())), MONTH_OF_YEAR((byte) 4, ISOChronology.getInstanceUTC().monthOfYear()), DAY_OF_MONTH((byte) 5, ISOChronology.getInstanceUTC().dayOfMonth()), HOUR_OF_DAY((byte) 6, ISOChronology.getInstanceUTC().hourOfDay()), MINUTES_OF_HOUR((byte) 7, ISOChronology.getInstanceUTC().minuteOfHour()), SECOND_OF_MINUTE((byte) 8, ISOChronology.getInstanceUTC().secondOfMinute());
