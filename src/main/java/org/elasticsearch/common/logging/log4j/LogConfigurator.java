...
public class LogConfigurator {
    ...
    public static void loadConfig(Path file, ImmutableSettings.Builder settingsBuilder) {
        ...
        } catch (FailedToResolveConfigException | NoClassDefFoundError
