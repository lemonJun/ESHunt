...
public class DocSetCacheModule extends AbstractModule {
    ...
    protected void configure() {
        bind(DocSetCache.class).to(settings.getAsClass("index.cache.docset.type", SimpleDocSetCache.class, "org.elasticsearch.index.cache.docset.", "DocSetCache")).in(Scopes.SINGLETON);
    }
}
