...
public class CodecService extends AbstractIndexComponent {
    ...
    @Inject
    public CodecService(Index index, @IndexSettings Settings indexSettings, PostingsFormatService postingsFormatService, DocValuesFormatService docValuesFormatService, MapperService mapperService) {
