...
public interface IndexFieldData<FD extends AtomicFieldData> extends IndexComponent {
    ...
    interface Builder {
        ...
        IndexFieldData<?> build(Index index, @IndexSettings Settings indexSettings, FieldMapper<?> mapper, IndexFieldDataCache cache, CircuitBreakerService breakerService, MapperService mapperService);
    }
