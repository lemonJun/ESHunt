...
public class ShardSearchService extends AbstractIndexShardComponent {
    ...
    static class StatsHolder {
        ...
        public SearchStats.Stats stats() {
            return new SearchStats.Stats(queryMetric.count(), TimeUnit.NANOSECONDS.toMillis(queryMetric.sum()), queryCurrent.count(), fetchMetric.count(), TimeUnit.NANOSECONDS.toMillis(fetchMetric.sum()), fetchCurrent.count());
        }
