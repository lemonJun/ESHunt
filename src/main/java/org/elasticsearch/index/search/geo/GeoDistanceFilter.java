...
public class GeoDistanceFilter extends Filter {
    ...
    public static class GeoDistanceDocSet extends MatchDocIdSet {
        ...
        public GeoDistanceDocSet(int maxDoc, @Nullable Bits acceptDocs, MultiGeoPointValues values, GeoDistance.FixedSourceDistance fixedSourceDistance, GeoDistance.DistanceBoundingCheck distanceBoundingCheck, double distance) {
