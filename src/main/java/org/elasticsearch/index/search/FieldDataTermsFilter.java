...
public abstract class FieldDataTermsFilter extends Filter {
    ...
    public boolean equals(Object obj) {
        ...
        if (!fieldData.getFieldNames().indexName().equals(that.fieldData.getFieldNames().indexName()))
            return false;
        return true;
    }
    ...
    protected static class BytesFieldDataFilter extends FieldDataTermsFilter {
        ...
        public String toString() {
            ...
            return sb.append(fieldData.getFieldNames().indexName()).append(":").append(terms != null ? terms.toString() : "").toString();
        }
