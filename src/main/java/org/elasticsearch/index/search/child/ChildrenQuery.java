...
public class ChildrenQuery extends Query {
    ...
    public String toString(String field) {
        ...
        return "ChildrenQuery[min(" + Integer.toString(minChildren) + ") max(" + Integer.toString(max) + ")of " + childType + "/" + parentType + "](" + originalChildQuery.toString(field) + ')' + ToStringUtils.boost(getBoost());
    }
    ...
    public Weight createWeight(IndexSearcher searcher) throws IOException {
        ...
        return new ParentWeight(rewrittenChildQuery.createWeight(searcher), parentFilter, numFoundParents, collector, minChildren, maxChildren);
    }
