...
public class IndexQueryParserModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        MapBinder<String, FilterParserFactory> filterBinder = MapBinder.newMapBinder(binder(), String.class, FilterParserFactory.class);
        ...
        for (Map.Entry<String, Settings> entry : xContentFilterParserGroups.entrySet()) {
            ...
            filterBinder.addBinding(fName).toProvider(FactoryProvider.newFactory(FilterParserFactory.class, fSettings.getAsClass("type", null))).in(Scopes.SINGLETON);
        }
