...
public interface FieldMapper<T> extends Mapper {
    ...
    public static class Names {
        ...
        public boolean equals(Object o) {
            ...
            if (!fullName.equals(names.fullName))
                return false;
            if (!indexName.equals(names.indexName))
                return false;
            if (!indexNameClean.equals(names.indexNameClean))
                return false;
            if (!name.equals(names.name))
                return false;
            if (!sourcePath.equals(names.sourcePath))
                return false;
