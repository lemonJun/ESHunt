...
public class GeoShapeFieldMapper extends AbstractFieldMapper<String> {
    ...
    public static class Builder extends AbstractFieldMapper.Builder<Builder, GeoShapeFieldMapper> {
        ...
        public GeoShapeFieldMapper build(BuilderContext context) {
            ...
            return new GeoShapeFieldMapper(names, prefixTree, strategyName, distanceErrorPct, orientation, fieldType, postingsProvider, docValuesProvider, multiFieldsBuilder.build(this, context), copyTo);
        }
    }
    ...
    public GeoShapeFieldMapper(FieldMapper.Names names, SpatialPrefixTree tree, String defaultStrategyName, double distanceErrorPct, Orientation shapeOrientation, FieldType fieldType, PostingsFormatProvider postingsProvider, DocValuesFormatProvider docValuesProvider, MultiFields multiFields, CopyTo copyTo) {
