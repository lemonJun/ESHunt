...
public class PercolatorService extends AbstractComponent {
    ...
    public PercolateShardResponse percolate(PercolateShardRequest request) {
        ...
        final PercolateContext context = new PercolateContext(request, searchShardTarget, indexShard, percolateIndexService, cacheRecycler, pageCacheRecycler, bigArrays, scriptService, aliasFilter);
        try {
