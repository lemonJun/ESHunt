...
public class RestUpdateSettingsAction extends BaseRestHandler {
    ...
    private static final ImmutableSet<String> VALUES_TO_EXCLUDE = ImmutableSet.<String> builder().add("pretty").add("timeout").add("master_timeout").add("index").add("expand_wildcards").add("ignore_unavailable").add("allow_no_indices").build();
