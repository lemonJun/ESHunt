...
public class BulkUdpService extends AbstractLifecycleComponent<BulkUdpService> {
    ...
    public BulkUdpService(Settings settings, Client client, NetworkService networkService) {
        ...
        logger.debug("using enabled [{}], host [{}], port [{}], bulk_actions [{}], bulk_size [{}], flush_interval [{}], concurrent_requests [{}]", enabled, host, port, bulkActions, bulkSize, flushInterval, concurrentRequests);
    }
