...
import org.elasticsearch.action.termvector.TransportMultiTermVectorsAction;
import org.elasticsearch.action.termvector.TransportSingleShardMultiTermsVectorAction;
...
public class ActionModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        registerAction(SearchAction.INSTANCE, TransportSearchAction.class, TransportSearchDfsQueryThenFetchAction.class, TransportSearchQueryThenFetchAction.class, TransportSearchDfsQueryAndFetchAction.class, TransportSearchQueryAndFetchAction.class, TransportSearchScanAction.class);
