 ...
 *
 */
public class TransportUpgradeSettingsAction extends TransportMasterNodeOperationAction<UpgradeSettingsRequest, UpgradeSettingsResponse> {

    private final MetaDataUpdateSettingsService updateSettingsService;

    @Inject
    public TransportUpgradeSettingsAction(Settings settings, TransportService transportService, ClusterService clusterService, ThreadPool threadPool, MetaDataUpdateSettingsService updateSettingsService, ActionFilters actionFilters) {
    ...
    @Override
    protected UpgradeSettingsRequest newRequest() {
        return new UpgradeSettingsRequest();
    }
