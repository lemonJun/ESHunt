...
/**
 * dfs_search_then_fetch 查询
 *
 * @author WangYazhou
 * @date  2017年4月5日 下午3:24:55
 * @see
 */
public class TransportSearchDfsQueryThenFetchAction extends TransportSearchTypeAction {

    private static final Logger logger = LoggerFactory.getLogger(TransportSearchDfsQueryThenFetchAction.class);
    ...
    private class AsyncAction extends BaseAsyncAction<DfsSearchResult> {
        ...
        void executeFetchPhase() {
            try {
                logger.info("executor fetch phase");
