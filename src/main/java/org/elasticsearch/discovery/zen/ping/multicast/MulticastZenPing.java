...
public class MulticastZenPing extends AbstractLifecycleComponent<ZenPing> implements ZenPing {
    ...
    protected void doStart() throws ElasticsearchException {
        try {
            ...
            multicastChannel = MulticastChannel.getChannel(nodeName(), shared, new MulticastChannel.Config(port, group, bufferSize, ttl, networkService.resolvePublishHostAddress(address)), new Receiver());
        } catch (Throwable t) {
