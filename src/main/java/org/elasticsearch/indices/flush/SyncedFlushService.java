...
public class SyncedFlushService extends AbstractComponent {
    ...
    **/
    ...
    void sendSyncRequests(final String syncId, final List<ShardRouting> shards, ClusterState state, Map<String, Engine.CommitId> expectedCommitIds, final ShardId shardId, final int totalShards, final ActionListener<ShardsSyncedFlushResult> listener) {
        ...
        for (final ShardRouting shard : shards) {
            ...
            if (state.nodes().localNode().id().equals(node.id())) {
                ...
                transportService.sendRequest(node, SYNCED_FLUSH_ACTION_NAME, new SyncedFlushRequest(shard.shardId(), syncId, expectedCommitId), new BaseTransportResponseHandler<SyncedFlushResponse>() {
                    @Override
    ...
    private void contDownAndSendResponseIfDone(String syncId, List<ShardRouting> shards, ShardId shardId, int totalShards, ActionListener<ShardsSyncedFlushResult> listener, CountDown countDown, Map<ShardRouting, SyncedFlushResponse> results) {
        if (countDown.countDown()) {
    ...
    final static class PreSyncedFlushRequest extends TransportRequest {
        ...
        public String toString() {
            return "PreSyncedFlushRequest{" + "shardId=" + shardId + '}';
        }
    ...
    static final class SyncedFlushRequest extends TransportRequest {
        ...
        @Override
        public String toString() {
            return "SyncedFlushRequest{" + "shardId=" + shardId + ",syncId='" + syncId + '\'' + '}';
        }
    }
    ...
    public static final class SyncedFlushResponse extends TransportResponse {
        ...
        @Override
        public String toString() {
            return "SyncedFlushResponse{" + "success=" + success() + ", failureReason='" + failureReason + '\'' + '}';
        }
    }
