...
public class RoutingTable implements Iterable<IndexRoutingTable> {
    ...
    public static class Builder {
        ...
        public Builder addAsFromDangling(IndexMetaData indexMetaData) {
            if (indexMetaData.state() == IndexMetaData.State.OPEN) {
                IndexRoutingTable.Builder indexRoutingBuilder = new IndexRoutingTable.Builder(indexMetaData.index()).initializeAsFromDangling(indexMetaData);
                add(indexRoutingBuilder);
            }
            return this;
        }
        ...
        public Builder addAsFromCloseToOpen(IndexMetaData indexMetaData) {
            if (indexMetaData.state() == IndexMetaData.State.OPEN) {
                IndexRoutingTable.Builder indexRoutingBuilder = new IndexRoutingTable.Builder(indexMetaData.index()).initializeAsFromCloseToOpen(indexMetaData);
                add(indexRoutingBuilder);
            }
            return this;
        }
