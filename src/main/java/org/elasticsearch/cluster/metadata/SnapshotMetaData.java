...
public class SnapshotMetaData implements MetaData.Custom {
    ...
    public static class Entry {
        ...
        public boolean equals(Object o) {
            ...
            if (includeGlobalState != entry.includeGlobalState)
                return false;
            if (!indices.equals(entry.indices))
                return false;
            if (!shards.equals(entry.shards))
                return false;
    ...
    public static class ShardSnapshotStatus {
        ...
        public boolean equals(Object o) {
            ...
            if (nodeId != null ? !nodeId.equals(status.nodeId) : status.nodeId != null)
                return false;
            if (reason != null ? !reason.equals(status.reason) : status.reason != null)
                return false;
    ...
    public static enum State {
        INIT((byte) 0, false, false), STARTED((byte) 1, false, false), SUCCESS((byte) 2, true, false), FAILED((byte) 3, true, true), ABORTED((byte) 4, false, true), MISSING((byte) 5, true, true), WAITING((byte) 6, false, false);
