...
public class OrderedDownstreamChannelEvent implements ChannelEvent {
     ...
     */
    public OrderedDownstreamChannelEvent(final OrderedUpstreamMessageEvent oue, final int subsequence, boolean last, final ChannelEvent ce) {
        this.oue = oue;
        this.ce = ce;
     ...
     */
    public OrderedDownstreamChannelEvent(final OrderedUpstreamMessageEvent oe, final Object message) {
     ...
     */
    public OrderedDownstreamChannelEvent(final OrderedUpstreamMessageEvent oue, final int subsequence, boolean last, final Object message) {
