...
public class HashedAggregator {
    ...
    public void addValue(BytesRef value, int hashCode) {
        ...
        assert assertHash.addNoCount(value, hashCode) == added : "asserting counter diverged from current counter - value: " + value + " hash: " + hashCode;
    }
    ...
    protected void onValue(int docId, BytesRef value, int hashCode) {
        ...
        assert assertHash.add(BytesRef.deepCopyOf(value), hashCode) == added : "asserting counter diverged from current counter - value: " + value + " hash: " + hashCode;
    }
