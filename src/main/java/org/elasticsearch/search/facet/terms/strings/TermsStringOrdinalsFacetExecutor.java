...
public class TermsStringOrdinalsFacetExecutor extends FacetExecutor {
    ...
    public TermsStringOrdinalsFacetExecutor(IndexOrdinalsFieldData indexFieldData, int size, int shardSize, TermsFacet.ComparatorType comparatorType, boolean allTerms, SearchContext context, ImmutableSet<BytesRef> excluded, Pattern pattern, int ordinalsCacheAbove) {
