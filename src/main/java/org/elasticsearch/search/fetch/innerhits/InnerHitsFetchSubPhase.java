...
public class InnerHitsFetchSubPhase implements FetchSubPhase {
    ...
    public Map<String, ? extends SearchParseElement> parseElements() {
        return ImmutableMap.of("inner_hits", new InnerHitsParseElement(sortParseElement, sourceParseElement, highlighterParseElement, fieldDataFieldsParseElement, scriptFieldsParseElement));
    }
