...
public class MinAggregator extends NumericMetricsAggregator.SingleValue {
    ...
    public MinAggregator(String name, long estimatedBucketsCount, ValuesSource.Numeric valuesSource, @Nullable ValueFormatter formatter, AggregationContext context, Aggregator parent) {
