...
public class TopHitsAggregator extends MetricsAggregator implements ScorerAware {
    ...
    public TopHitsAggregator(FetchPhase fetchPhase, SubSearchContext subSearchContext, String name, long estimatedBucketsCount, AggregationContext context, Aggregator parent) {
    ...
    public void collect(int docId, long bucketOrdinal) throws IOException {
        ...
        if (topDocsCollector == null) {
            ...
            topDocsCollectors.put(bucketOrdinal, topDocsCollector = sort != null ? TopFieldCollector.create(sort, topN, true, subSearchContext.trackScores(), subSearchContext.trackScores(), false) : TopScoreDocCollector.create(topN, false));
    ...
    public static class Factory extends AggregatorFactory {
        ...
        public Aggregator create(AggregationContext aggregationContext, Aggregator parent, long expectedBucketsCount) {
            return new TopHitsAggregator(fetchPhase, subSearchContext, name, expectedBucketsCount, aggregationContext, parent);
        }
