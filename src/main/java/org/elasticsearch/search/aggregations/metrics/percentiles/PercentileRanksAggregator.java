...
public class PercentileRanksAggregator extends AbstractPercentilesAggregator {
    ...
    public PercentileRanksAggregator(String name, long estimatedBucketsCount, Numeric valuesSource, AggregationContext context, Aggregator parent, double[] percents, double compression, boolean keyed, @Nullable ValueFormatter formatter) {
    ...
    public InternalAggregation buildAggregation(long owningBucketOrdinal) {
        ...
        if (state == null) {
            ...
            return new InternalPercentileRanks(name, keys, state, keyed, formatter);
        }
    }

    @Override
    public InternalAggregation buildEmptyAggregation() {
        return new InternalPercentileRanks(name, keys, new TDigestState(compression), keyed, formatter);
    }
    ...
    public static class Factory extends ValuesSourceAggregatorFactory.LeafOnly<ValuesSource.Numeric> {
        ...
        protected Aggregator create(ValuesSource.Numeric valuesSource, long expectedBucketsCount, AggregationContext aggregationContext, Aggregator parent) {
            return new PercentileRanksAggregator(name, expectedBucketsCount, valuesSource, aggregationContext, parent, values, compression, keyed, config.formatter());
        }
    }
}
