...
public class StatsAggegator extends NumericMetricsAggregator.MultiValue {
    ...
    public InternalAggregation buildAggregation(long owningBucketOrdinal) {
        ...
        return new InternalStats(name, counts.get(owningBucketOrdinal), sums.get(owningBucketOrdinal), mins.get(owningBucketOrdinal), maxes.get(owningBucketOrdinal), formatter);
    }
