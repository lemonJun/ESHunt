...
public class ExtendedStatsAggregator extends NumericMetricsAggregator.MultiValue {
    ...
    public InternalAggregation buildAggregation(long owningBucketOrdinal) {
        ...
        return new InternalExtendedStats(name, counts.get(owningBucketOrdinal), sums.get(owningBucketOrdinal), mins.get(owningBucketOrdinal), maxes.get(owningBucketOrdinal), sumOfSqrs.get(owningBucketOrdinal), sigma, formatter);
    }
