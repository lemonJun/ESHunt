...
public enum ValueType {
    ...
    @Deprecated
    ANY("any", ValuesSource.class, IndexFieldData.class, null), STRING("string", ValuesSource.Bytes.class, IndexFieldData.class, null), LONG("byte|short|integer|long", ValuesSource.Numeric.class, IndexNumericFieldData.class, ValueFormat.RAW) {
        @Override
