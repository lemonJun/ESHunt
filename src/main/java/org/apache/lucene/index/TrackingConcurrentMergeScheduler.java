...
public class TrackingConcurrentMergeScheduler extends ConcurrentMergeScheduler {
    ...
    protected void doMerge(MergePolicy.OneMerge merge) throws IOException {
        ...
        try {
            ...
            String message = String.format(Locale.ROOT, "merge segment [%s] done: took [%s], [%,.1f MB], [%,d docs]", merge.info == null ? "_na_" : merge.info.info.name, TimeValue.timeValueMillis(tookMS), totalSizeInBytes / 1024f / 1024f, totalNumDocs);
