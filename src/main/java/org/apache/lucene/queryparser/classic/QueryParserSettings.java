...
public class QueryParserSettings {
    ...
    public boolean equals(Object o) {
        ...
        if (autoGeneratePhraseQueries != that.autoGeneratePhraseQueries())
            return false;
        if (maxDeterminizedStates != that.maxDeterminizedStates())
            return false;
        ...
        if (fuzzyPrefixLength != that.fuzzyPrefixLength)
            return false;
        if (fuzzyMaxExpansions != that.fuzzyMaxExpansions)
            return false;
        ...
        if (fields != null ? !fields.equals(that.fields) : that.fields != null)
            return false;
        if (queryTypes != null ? !queryTypes.equals(that.queryTypes) : that.queryTypes != null)
            return false;
